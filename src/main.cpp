...
// Copyright (c) 2015 The MMXVI developers
...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x00092a5ce018826e500c312c3127eda08d4618a31ba98bb6d33fb4a33506da86");
uint256 hashGenesisBlockTestNet("0x000683b13e25acaeb4b7543257da5a257c2035bde0bd4e4e17505e374d51e29e");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0x12e82662035aee14b1e58de0f22c8d710f0ecc9342fa8f9a5033885480cbff24");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1451920000;
static const unsigned int timeGenesisBlockTestNet =1451920000;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=5290;
static const unsigned int nNonceGenesisTestNet=11597;
//----------------------------------------------------
...
const string strMessageMagic = "MMXVI Signed Message:\n";
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since MMXVI version 2.0 at block 100,000]
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "New year means new coin.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("06138bbdb0fe5548271967f1a67130b4795cd6a828e03909a25362e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c211df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        CBlock block;
        ...
        while (hash > bnProofOfWorkLimit.getuint256()){
            ...
            hash = block.GetHash();
			//printf("nonce=%u hash=%s target=%s\n",block.nNonce, hash.ToString().c_str(),bnProofOfWorkLimit.getuint256().ToString().c_str());
        }
...
unsigned char pchMessageStart[4] = { 0xc3, 0xff, 0xd2, 0xb4 };
