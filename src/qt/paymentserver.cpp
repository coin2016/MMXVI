...
const QString BITCOIN_IPC_PREFIX("MMXVI:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click MMXVI: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start MMXVI: click-to-pay handler");
    else
...
{
    // clicking on MMXVI: URLs creates FileOpen events on the Mac:
